% Tim Truster
% 08/21/2013
% Reordering nodes for surface load integration, from standard orientation
% to element orientation.

% Modified 07/29/2014: added pressure loading by allowing edge to be signed
% Took a very long time to find this oversight.
esign = sign(edge);
edge = abs(edge);
