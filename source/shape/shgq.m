function [shgd,shgs,det,bubble,sx] = shgq(xl,nel,shld,shls,nen,bf,der,bubble)                
% c                                                                          
...
% c     ----------------------------------------------------------
%         for  i=1:nel
%           shgd(1,i) = shld(1,i)*xs(1,1) + shld(2,i)*xs(2,1);
%           shgd(2,i) = shld(1,i)*xs(1,2) + shld(2,i)*xs(2,2);
%         end
        shgd = shld*xs;
% c
